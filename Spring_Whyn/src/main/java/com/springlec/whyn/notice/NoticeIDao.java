...
public interface NoticeIDao {
	...
	public ArrayList<NoticeDto> noticeSearch(String result1, String result2); //검색
...
//	public void nviewcount(String nno); //공지 조회수+1
//	public int nviewSelect(String nno); //공지 조회수값 가져오기 

...
public class aReViewDto {
	...
	public aReViewDto(int reno, String reuserid, String retitle, String recontent, Timestamp reinsertdate,
			int reviewcount) {
		super();
		this.reno = reno;
	...
	public aReViewDto(String reviewSearchBox, String reviewSearchBar) {
		super();
		this.reviewSearchBox = reviewSearchBox;
		this.reviewSearchBar = reviewSearchBar;
	}

	public aReViewDto(int reno, String reuserid, String retitle, String recontent, int rescore, Timestamp reinsertdate,
			String reviewSearchBox) {
		super();
		this.reno = reno;
		this.reuserid = reuserid;

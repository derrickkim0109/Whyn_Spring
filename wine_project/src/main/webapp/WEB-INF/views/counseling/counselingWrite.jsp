...
<div class="container">
<p style="color:#997f49; font-size:25px; padding:20px; font-weight: bold" >문의글 작성</p>
	...
	<div style="margin:0 auto; text-align:center;">		
		...
		<table>
			<tr>
				...
				<td> <input type="text" name = "ctitle" placeholder="제목을 입력해주세요." style="margin: 20px; width:380px; padding:10px;"> </td>
			</tr>
			
			<tr>
				<td style="color:#997f49;"> 내용 </td>
				<td> <textarea style="resize:none; text-align:left; width:360px; height:130px; padding:20px; clear:both;" placeholder="후기내용을 입력해주세요." name ="ccontent"></textarea> </td>
			</tr>
			
			<tr>
				<td colspan="2"><input type="submit" value="작성" style="width:50px; height:30px; color:#997f49; border:1px #997f49 solid; background: #fff;"></td></tr>
		</table>
